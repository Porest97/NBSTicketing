...
namespace NBSTicketing.Controllers
{
    public class TicketTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketTypeName")] TicketType ticketType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TicketTypeName")] TicketType ticketType)
        {
            if (id != ticketType.Id)
            {
                return NotFound();
